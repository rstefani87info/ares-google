...
### Module notes (google)
- Security hardening: validate config at startup and never log secrets.
- Add tests using mocks/stubs that do not require real credentials.

## References
- Main doc EN: ./google.md
- Main doc IT: ../it/google.md
